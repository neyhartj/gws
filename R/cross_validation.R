...
#'
#' @param phenotype A n x 1 \code{matrix} of phenotypes where n is the number
#' of lines/entries. Row names should be entry/line names. The function assumes
...
#'
#'
cross.val <- function(phenotype, genotypes, cv.method = c("fractional", "k-fold"), frac.train = 0.60, frac.reps = 250, folds = 10, fold.reps = 25, model = "RRBLUP") {
